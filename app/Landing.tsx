            ...
            <div className="container pt-32 pb-20">
                ...
                <div className="max-w-[800px] mx-auto text-center space-y-8 mb-20">
                    <div className="space-y-6">
                        ...
                        Move beyond simple to-do lists with powerful tools designed to 
                        effortlessly prioritize, organize, and manage your projects and tasks.
                        </p>
                    </div>
                ...
                <div className="relative w-full max-w-[1200px] mx-auto mt-20">
                    <div className="relative bg-background/95 backdrop-blur rounded-lg shadow-2xl">
                        <Image
                            src={resolvedTheme === 'dark' ? '/gitish-dark.png' : '/gitish-light.png'}
                            alt="App preview"
                            width={1824}
                            height={1080}
